    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=customers.models.Bonus.default_expires_at, verbose_name='Дата сгорания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, unique=True, verbose_name='Статус промокоода')),
                ('is_personal', models.BooleanField(default=False, unique=True, verbose_name='Персональный промокод')),
            ],
            options={
